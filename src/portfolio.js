let projects = [
  {
    ...
    description:
      "Full Stack App for fishing enthusiasts to keep track of the fish they catch.  Designed using React.js with TypeScript in the Front End.  Graphics were made utilizing Adobe Creative Cloud.  Backend API was designed with Java Sprint and PostGreSQL.",
  ...
  },
  {
    ...
    tech: ["React.js", "TypeScript", "Java Spring Boot"],
    description:
      "Full Stack App designed to assist Stock Traders in analyzing and keeping up-to-date with their stock trades.  React.js and TypeScript were used to design the Front End along with other React friendly libraries.  Backend API uses Java Spring and Authentication to communicate with the User Interface.",
